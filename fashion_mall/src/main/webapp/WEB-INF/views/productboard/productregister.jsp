	...
	<div class="container center-contents">
		<div class="row">
			<form method="" class="form-signin">
				...
				<div class="form-group">
					<label for="price" class="sr-only">상품재고</label>
					<input type="text" id="price" name="price" class="form-control" placeholder="상품재고" required/>
				</div>
				
				<button class="btn btn-lg btn-primary btn-block" type="submit">상품등록</button>
				</form>
		</div>
	</div>
<script>
