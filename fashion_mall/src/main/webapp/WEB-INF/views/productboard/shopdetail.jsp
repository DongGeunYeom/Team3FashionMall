...
<body>
    ...
    <!-- Js Plugins -->
    <script src="/resources/js/ashion/jquery-3.3.1.min.js"></script>
    <script src="/resources/js/ashion/bootstrap.min.js"></script>
    <script src="/resources/js/ashion/jquery.magnific-popup.min.js"></script>
    <script src="/resources/js/ashion/jquery-ui.min.js"></script>
    <script src="/resources/js/ashion/mixitup.min.js"></script>
    <script src="/resources/js/ashion/jquery.countdown.min.js"></script>
    <script src="/resources/js/ashion/jquery.slicknav.js"></script>
    <script src="/resources/js/ashion/owl.carousel.min.js"></script>
    <script src="/resources/js/ashion/jquery.nicescroll.min.js"></script>
    <script src="/resources/js/ashion/main.js"></script>
</body>
