                ...
                <div class="row">
                    <div  class="col-md-6">
                        <div class="header-top-content">
                            ...
                            <li><input type="text" name="" id="" /> &nbsp  &nbsp</li>
                            
			<li><a href="#" class="search-btn"><i class="fa fa-search" aria-hidden="true" style="font-size:20px"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    <div  class="col-md-6">
                        ...
                        <ul class="nav nav-pills navbar-right" >
                                ...
                                <li class="dropdown button" onclick="dp_menu()">
                                	<a href="#" >
