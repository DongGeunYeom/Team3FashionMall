	...
	<!-- Carousel -->
		...
		<!-- Three -->
			<section id="three" class="main style1 special">
				<div class="container">
					<header class="major">
						<h2 align="left" >인기 상품 Top 3</h2>
						<div class="btn-group" role="group" aria-label="Basic example">
						  <button type="button" class="btn btn-dark" id="top" style="margin-top: 10px; width: 70px; height: 50px">TOP</button>
						  <button type="button" class="btn btn-dark" id="bottom" style="margin-top: 10px; width: 70px; height: 50px">BOTTOM</button>
						  <button type="button" class="btn btn-dark" id="outer" style="margin-top: 10px; width: 70px; height: 50px">OUTER</button>
						  <button type="button" class="btn btn-dark" id="shoes" style="margin-top: 10px; width: 70px; height: 50px">SHOES</button>
						  <button type="button" class="btn btn-dark" id="stuff" style="margin-top: 10px; width: 70px; height: 50px">STUFF</button>
						</div>
					</header>
					<br>
