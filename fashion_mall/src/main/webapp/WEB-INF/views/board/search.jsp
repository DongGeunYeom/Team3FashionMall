	...
	<form action="" method="get" id="searchForm">
		<table>
			...
			<tr>
				...
				<td rowspan="2"><button type="submit" id="searchBtn">searchB</button></td>
			</tr>
			<tr>
				<td>상품 정렬</td>
				<td>
				...
				<td>상세 내용</td>
				<td>
					<input type="text" name="content" class="input"  id="" placeholder="검색어를 입력하세요" style="text-align:center;" value="${cri.content}" />
				</td>
			</tr>
		</table>
	</form>
