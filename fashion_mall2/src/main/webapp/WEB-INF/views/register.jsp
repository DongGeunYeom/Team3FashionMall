...
<header class="bg-dark py-1">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder" onclick="location.href='/'">Register</h1>
...
<form id="regist" method="post" class="form-signin" action="/regist">
...
<input type="checkbox" name="agree" value="true"> 약관동의(필수)
</label>
<label for="" class="col-sm-2 col-form-label"></label>	
        ...
        <div class="form-group row justify-content-left">
          ...
          <div class="col-sm-6">
            ...
            />
            <small id="phonenum" class="text-info"></small>
          </div>
        </div>
        <!-- 주민 등록 창 끝 -->
        <div class="form-group row justify-content-left">
	        <div class="col-sm-6">
				<button class="btn btn-outline-secondary" type="submit">회원가입</button>
	        </div>
	    </div>
<!-- 토큰이 없으면 403 에러 -->
